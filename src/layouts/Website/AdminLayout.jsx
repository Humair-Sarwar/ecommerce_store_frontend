...
const NAVIGATION = [
  ...
  {
    segment: 'vendor/settings',
    title: 'Settings',
    icon: <SettingsIcon />,
    children: [
      {
        segment: 'site-settings',
        title: 'Site Settings',
        icon: <CircleIcon sx={{fontSize: '6px'}}/>
      }
    ]
...
<>
     ...
     <AppProvider
      ...
      >
         <DashboardLayout className='test...............'>
      <Outlet />
    </DashboardLayout>
      </AppProvider>
