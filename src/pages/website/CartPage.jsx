      ...
      <Table sx={{ minWidth: '100%' }}>
        <TableHead className='cart-p-heading-target'>
          <TableRow>
            ...
            <TableCell align="right"  sx={{fontWeight: '600', fontSize: '15px', py: 3}}>Total</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
              ...
              <TableCell align="center" component="td" className='right-cart-content-side-cart-page' sx={{border: '0 !important'}}>
                ...
                <TableCell align="right" component="td" sx={{width: '20%', border: '0 !important'}} className='total-p-target-cart'><Typography>£2,255.00
                  ...
                  <Grid size={{ xs: 12, sm: 12, md: 6, lg: 4 }}>
                    <Box sx={{p: 5, border: '1px solid rgb(26 26 26 / 12%)', borderRadius: '15px', backgroundColor: 'white'}}>
                        <Box sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2}}><Typography variant='body1'>Subtotal</Typography> <Typography variant='body1'>£7,376.40
</Typography></Box>
<Box sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2}}><Typography variant='h3' sx={{fontSize: '22px', fontWeight: '600'}}>Total</Typography>
<Typography variant='h3' sx={{fontSize: '22px', fontWeight: '600'}}>£7,376.40 GBP
</Typography></Box>
<Typography variant="body1" sx={{fontSize: '14px', color: 'rgb(26 26 26 / 70%)', mb: 3}}>Tax included. <Link to={'/'} className="shipping-link-page-style">Shipping</Link> calculated at checkout.</Typography>
 <TextField
            fullWidth
      ...
      </svg></Box> checkout</Button>
                    </Box>
                    <Box>
                        <Typography variant='body2' sx={{mt: 3, mb: 2, textAlign: 'center', color: 'rgb(26 26 26 / 70%)', fontSize: '12px'}}>We accept</Typography>
                        <Box className='footer-bottom-payment-options-style' sx={{textAlign: 'center'}}>
