...
const responsive = {
  ...
  return (
    ...
    <Box sx={{position: 'relative', pt: 6, backgroundColor: "#f0f0f0"}}>
      <img src="/High-Tech-Devices-Eclat-UK_1.png" className='banner-image-style' alt="" />
      <Box className='featured-product-box-target'>
        <Typography variant='h5' sx={{fontSize: '12px', color: 'white', fontWeight: '600', textAlign: 'end', mb: 1, mr: 2}}>Featured product</Typography>
...
<Box sx={{display: 'flex', alignItems: 'center'}}>
  ...
  <Box sx={{ mx: 2}}>
    <Typography variant='h4' sx={{fontSize: '14px', fontWeight: '600', color: 'white', width: '180px', lineHeight: '25px'}}>Apple iPhone 15 Pro Max Unlocked - 1 TB Storage</Typography>
    <Typography variant='body2' sx={{color: 'rgb(255 255 255 / 70%)', marginTop: '5px'}}>£1,150.00</Typography>
  </Box>
</Box>
        </Link>
      </Box>
    </Box>
      <Box sx={{ backgroundColor: "#f0f0f0", pt: 6, px: 4, textAlign: 'center', pb: 2 }}>
        <Typography variant='h2' className='p-listing-p-heading-main'>Mobile & Computing</Typography>
      </Box>
      <Box sx={{ backgroundColor: "#f0f0f0", py: 5}} className={`${ 4 > 4 ? '' : 'categories-list-row-target'}`}>
...
<Box sx={{backgroundColor: "#f0f0f0", py: 5}}>
  ...
  <Box sx={{   display: 'flex' }}>
        <Box className='p-listing-page-left-menu-target' sx={{ pr: 5}}>
          <Typography sx={{display: 'flex', alignItems: 'center', py: 3}}><svg role="presentation" fill="none" focusable="false" stroke-width="2" width="20" height="14" class="icon-subdued icon icon-filter" viewBox="0 0 20 14">
